...
export const SOFTWARE_FILTERS: SoftwareFiltersConfig = {
  ...
  include: [
    /^hppM125LaserJetService/i,
    /^hppM201-M202LaserJetService/i,
    /^hppcp1025LaserJetService/i,
  ...
  normalize: [
    ...
    { pattern: /hppM125LaserJetService$/i, replacement: 'HP 125 LaserJet' },
    { pattern: /hppM201-M202LaserJetService$/i, replacement: 'HP 201-202 LaserJet' },
    { pattern: /hppcp1025LaserJetService$/i, replacement: 'HP 1025 LaserJet' },
